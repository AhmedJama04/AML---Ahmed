    ...
    <x-slot:content>
        <main class="flex justify-center items-center h-screen">
            <div
                ...
                <h1 class="text-[35px]">User Verification</h1>
                @if ($errors->any())
                ...
                <form action="{{ route('submit.register') }}" method="POST"
                    class="w-full h-full flex items-center flex-col">
                    @csrf
                    ...
                    <a href="{{ route('successful') }}"
                        class="bg-white w-[4vw] h-[3%] rounded-[5px] shadow-sm mt-[10px] active:bg-gray-50 text-black">Submit</a>
                </form>
            </div>
        </main>
    </x-slot>
